...
with tab1:
    ...
    with col1:
        ...
        st.write("   **-> Bank Balance checking**")
        st.write("   **->Money Storage**")
        st.write("   **->PIN Authorization**")
        st.download_button("DOWNLOAD THE APP NOW", "https://www.phonepe.com/app-download/")
    with col2:
        st.video("D:\\Hariharan\\YTdataproject\\Phonepe\\phonepead.mp4")
    col3,col4= st.columns(2)

    with col3:
        st.video("D:\\Hariharan\\YTdataproject\\Phonepe\\phonepead2.mp4")
    with col4:
    ...
    with col6:
        st.video("D:\\Hariharan\\YTdataproject\\Phonepe\\phonepead3.mp4")
